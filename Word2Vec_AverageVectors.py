...
if __name__ == '__main__':
    ...
    # Read data1 from files
    train = pd.read_csv( os.path.join(os.path.dirname(__file__), 'data2', 'labeledTrainData.csv'), header=0, delimiter="\t", quoting=3 )
    test = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data2', 'testData.csv'), header=0, delimiter="\t", quoting=3 )
    unlabeled_train = pd.read_csv( os.path.join(os.path.dirname(__file__), 'data2', "unlabeledTrainData.csv"), header=0,  delimiter="\t", quoting=3 )
    ...
    # If you don't plan to train the model 2ny further, calling
    ...
    #
    print "Creating average feature vecs for training paper content"
